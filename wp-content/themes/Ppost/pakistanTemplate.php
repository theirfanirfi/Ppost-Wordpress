				...
				<div class="col-md-5 same picturesvideosandletters visible-desktop">
					...
					<div class="row mycarouzel" style="">
						...
						<div id="carousel-example-generic" class="carousel slide" data-ride="carousel" style="margin:3px;height: 200px;">
                              ...
                              <?php $args = array( 'posts_per_page' => 1,'post_type'=>array('feature','entertainment','latest','sport','science','world'), 'cat' => 3,"orderby"=>'ID','order'=>'DESC' );
...
<!--							      <img src="Images/leadstory.jpg" alt="" style="height: 200px;width: 100%;">-->
                                ...
                                <?php }  wp_reset_postdata(); ?> 
                                   ...
                                   <?php $args = array( 'posts_per_page' => 5,'post_type'=>array('feature','entertainment','latest','sport','science','world'), 'cat' => 3,"orderby"=>'ID','order'=>'DESC' );

    $myposts = get_posts( $args );
    //var_dump($myposts);
                                  $x = 1;
    foreach ( $myposts as $post ) { setup_postdata( $post ); if($x==1){$x++; continue; }
...
<!--						<img src="Images/leadstory.jpg" class="img-responsive leadstoryImage" />-->
    ...
    foreach ( $myposts as $post ) { setup_postdata( $post ); if($x == 1) { $x++; continue; }
                ...
                <?php  $args = array('post_type' => 'sport','posts_per_page'=> 5, 'orderby' => 'ID', 'order' => 'DESC');
